...
var projectKey2Desc = {
   forge: 'Forge is a turn-based multiplayer strategy game built with Firebase and Unity. It combines elements from collectible card games, real-time strategy games, and deck-building games into a cohesive competitive experience.<br><br>Responsibilities included architecting networking, developing cloud functions, managing security rules, 3D modeling, game design, and gameplay programming. <br> <a href="https://www.youtube.com/watch?v=PpmXSqYiI3k">Watch the Video</a> or <a href="https://www.youtube.com/watch?v=PpmXSqYiI3k">try the Demo</a>!',
   thesis: 'Coined by Google in 2017, federated learning is a new machine learning paradigm. It allows clients to collaboratively learn a single model from separate datasets of sensitive information. The datasets remain private for the entire duration of the training process.<br><br>The thesis investigates the paradigm\'s robustness to adversarial attacks in both a horizontal and a vertical scenario. Both scenarios\' implementations featured the same model, same datasets, and same number of clients to increase the credibility of their comparison.<br><br><a href="./resources/Master_Thesis_Demeter.pdf" download>Download the Thesis</a>',
...
var projectKey2Src = {
   forge: 'resources/images/MapRender.png',
